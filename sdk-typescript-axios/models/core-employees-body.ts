 ...
 * 
 * @export
 * @interface CoreEmployeesBody
 */
export interface CoreEmployeesBody {
    /**
     * 
     * @type {string}
     * @memberof CoreEmployeesBody
     */
    email?: any;
    /**
     * 
     ...
     * @memberof CoreEmployeesBody
     */
    role?: CoreEmployeesBodyRoleEnum;
    /**
     * 
     * @type {string}
     * @memberof CoreEmployeesBody
     ...
     * @memberof CoreEmployeesBody
     */
    gender?: CoreEmployeesBodyGenderEnum;
    /**
     * 
     * @type {string}
     * @memberof CoreEmployeesBody
...
/**
    ...
    * @enum {string}
    */
export enum CoreEmployeesBodyRoleEnum {
    Basic = 'basic',
    Admin = 'admin'
}
/**
    ...
    * @enum {string}
    */
export enum CoreEmployeesBodyGenderEnum {
    Male = 'male',
    Female = 'female'
}
