 ...
 * 
 * @export
 * @interface EmployeesIdBody
 */
export interface EmployeesIdBody {
    /**
     * 
     * @type {string}
     * @memberof EmployeesIdBody
     */
    email?: any;
    /**
     * 
     ...
     * @memberof EmployeesIdBody
     */
    gender?: EmployeesIdBodyGenderEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeesIdBody
...
/**
    ...
    * @enum {string}
    */
export enum EmployeesIdBodyRoleEnum {
    Basic = 'basic',
    Admin = 'admin'
}
/**
    ...
    * @enum {string}
    */
export enum EmployeesIdBodyGenderEnum {
    Male = 'male',
    Female = 'female'
}
