...
/**
 * CoreMeApi - axios parameter creator
 * @export
 */
export const CoreMeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
...
/**
 * CoreMeApi - functional programming interface
 * @export
 */
export const CoreMeApiFp = function(configuration?: Configuration) {
    return {
        /**
         * After token grant, get information of the token holder
         * @summary Get information about current user
         ...
         * @throws {RequiredError}
         */
        async v1MeGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await CoreMeApiAxiosParamCreator(configuration).v1MeGet(options);
...
/**
 * CoreMeApi - factory interface
 * @export
 */
export const CoreMeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * After token grant, get information of the token holder
         * @summary Get information about current user
         ...
         * @throws {RequiredError}
         */
        v1MeGet(options?: any): AxiosPromise<void> {
            return CoreMeApiFp(configuration).v1MeGet(options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * CoreMeApi - object-oriented interface
 * @export
 * @class CoreMeApi
 * @extends {BaseAPI}
 */
export class CoreMeApi extends BaseAPI {
    /**
     * After token grant, get information of the token holder
     * @summary Get information about current user
     * @param {*} [options] Override http request option.
    ...
    public v1MeGet(options?: any) {
        return CoreMeApiFp(this.configuration).v1MeGet(options).then((request) => request(this.axios, this.basePath));
    }
}
