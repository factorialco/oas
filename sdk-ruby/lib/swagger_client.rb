...
# Models
require 'swagger_client/models/core_employees_body'
require 'swagger_client/models/employee'
require 'swagger_client/models/employees_id_body'

# APIs
require 'swagger_client/api/core_employees_v2_api'
require 'swagger_client/api/core_me_api'
