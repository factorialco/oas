...
# Unit tests for SwaggerClient::CoreMeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoreMeApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CoreMeApi.new
  end
  ...
  describe 'test an instance of CoreMeApi' do
    it 'should create an instance of CoreMeApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CoreMeApi)
    end
  end
