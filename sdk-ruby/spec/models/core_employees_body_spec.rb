...
# Unit tests for SwaggerClient::CoreEmployeesBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoreEmployeesBody' do
  before do
    # run before each test
    @instance = SwaggerClient::CoreEmployeesBody.new
  end
  ...
  describe 'test an instance of CoreEmployeesBody' do
    it 'should create an instance of CoreEmployeesBody' do
      expect(@instance).to be_instance_of(SwaggerClient::CoreEmployeesBody)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["basic", "admin"])
