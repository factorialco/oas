...
# Unit tests for SwaggerClient::EmployeesIdBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmployeesIdBody' do
  before do
    # run before each test
    @instance = SwaggerClient::EmployeesIdBody.new
  end
  ...
  describe 'test an instance of EmployeesIdBody' do
    it 'should create an instance of EmployeesIdBody' do
      expect(@instance).to be_instance_of(SwaggerClient::EmployeesIdBody)
    end
  end
