...
/**
 * API tests for CoreEmployeesV2Api
 */
@Ignore
public class CoreEmployeesV2ApiTest {

    private final CoreEmployeesV2Api api = new CoreEmployeesV2Api();
     ...
     */
    @Test
    public void v2CoreEmployeesGetTest() throws Exception {
        String fullTextName = null;
        List<Employee> response = api.v2CoreEmployeesGet(fullTextName);
     ...
     */
    @Test
    public void v2CoreEmployeesIdGetTest() throws Exception {
        String id = null;
        Employee response = api.v2CoreEmployeesIdGet(id);
     ...
     */
    @Test
    public void v2CoreEmployeesIdPutTest() throws Exception {
        String id = null;
        EmployeesIdBody body = null;
        Employee response = api.v2CoreEmployeesIdPut(id, body);
     ...
     */
    @Test
    public void v2CoreEmployeesPostTest() throws Exception {
        CoreEmployeesBody body = null;
        Employee response = api.v2CoreEmployeesPost(body);
