...
/**
 * CoreEmployeesBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CoreEmployeesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'core_employees_body';
...
self::GENDER_FEMALE,        ];
     ...
     *
     * @param int $legal_entity_id legal_entity_id
     *
     * @return $this
     */
